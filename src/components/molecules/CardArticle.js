...
export default function CardArticle() {
    ...
    return (
        <div
            className="overflow-hidden transition-shadow duration-300 bg-white rounded px-5 pt-5 mr-5 my-2"
            style={blogBox}
        >
            ...
            <div className="py-5">
                <div className="grid grid-cols-6 gap-1">
                    <div className="col-span-6">
                        ...
                        <small className="mb-1 text-gray-700">
                            Modernizacja kuchni, podobnie jak łazienki, wymaga dość dużego wkładu finansowego. Jeśli
                            planujesz kapitalny remont z zakupem nowego …
                        </small>
                    </div>
                </div>
            </div>
