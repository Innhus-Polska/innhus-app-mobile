    ...
    return (
        <div className={classes.root}>
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>{faqContent.section1answer1}</Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>{faqContent.section1answer2}</Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>{faqContent.section1answer3}</Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>{faqContent.section1answer4}</Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>{faqContent.section1answer5}</Typography>
                </AccordionDetails>
            </Accordion>
        </div>
    );
